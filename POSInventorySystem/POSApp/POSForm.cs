        ...
        private void btnCheckout_Click(object sender, EventArgs e)
        {
            ...
            using (var conn = dbHelper.GetConnection())
            {
                ...
                using (var trans = conn.BeginTransaction())
                {
                    ...
                    {
                        // Insert Sale
                        string saleQuery = "INSERT INTO Sales (TotalAmount) VALUES (@total); SELECT LAST_INSERT_ID();";
                        ...
                        {
                            // Insert Sale Item
                            string itemQuery = "INSERT INTO SaleItems (SaleID, ProductID, Quantity, UnitPrice) VALUES (@saleId, @prodId, @qty, @price)";
